...
export async function createFile({ filename, filesize, folderId, url }) {
...
export async function createShare({ code, folderId, durationSeconds }) {
...
export async function getAllShares(userId) {
...
export async function changeFolderId(fileId, originalFolderId, newFolderId) {
  await prisma.file.update({
    where: {
      id: fileId,
...
export async function changeFileUrl(fileId, newUrl, folderId) {
  await prisma.file.update({
    where: {
      id: fileId,
      folderId: folderId,
...
export async function deleteSharebyId(shareId) {
